...
void sli_zigbee_af_demand_response_load_control_cluster_dsa_sign_callback(sl_status_t status, uint8_t messageLength, uint8_t* messageContents)
{
  ...
  sl_zigbee_af_demand_response_load_control_cluster_println("sl_zigbee_dsa_sign_handler() returned 0x%02X",
                                                            status);
}
