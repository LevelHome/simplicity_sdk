/*******************************************************************************
 * @file
 * @brief OpenThread FTD certification configuration file.
 *******************************************************************************
 * # License
...
//
// <h> OpenThread Stack Configuration for FTD Certification

// <h> WARNING:
// </h>
// <h> Changing configuration values here will have ramifications on inheriting Thread certification using pre-built FTD certification libraries. If you must change any of these values, note that it requires rebuilding the FTD certification libraries.
// </h>
// <h>
// </h>
