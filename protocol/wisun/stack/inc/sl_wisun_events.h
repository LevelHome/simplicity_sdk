...
typedef enum {
  ...
  /// This event is sent on frame reception.
  /// The event is intended for test purposes, and cannot currently be
  /// used by applications.
  SL_WISUN_MSG_RX_FRAME_IND_ID                    = 0x8F,
  /// This event is sent on LFN wake up.
  SL_WISUN_MSG_LFN_WAKE_UP_IND_ID                 = 0x90,
  /// This event is sent when an LFN multicast group registration finishes.
