...
// IEEE 802.11
#define KDT_GTK                  0x01
#define KDT_PMKID                0x04
#define KDT_LIFETIME             0x07
// Wi-SUN
#define KDT_PTKID                0x01
#define KDT_GTKL                 0x02
#define KDT_NR                   0x03
#define KDT_LGTKL                0x04
#define KDT_LGTK                 0x05
...
/**
 * kde_lgtkl_write writes LGTK liveness information
 *
 * \param ptr pointer where to write
 * \param lgtkl LGTK liveness bit field
 *
 * return incremented write pointer
 *
 */
 ...
 *
 */
int8_t kde_gtk_read(uint8_t *ptr, uint16_t len, uint8_t *key_id, uint8_t *gtk);
 ...
 *
 */
int8_t kde_lgtk_read(uint8_t *ptr, uint16_t len, uint8_t *key_id, uint8_t *lgtk);

/**
 *  kde_lgtkl_read reads LGTK liveness information
 *
 * \param ptr pointer where to read
 * \param len length of the remaining data
 * \param lgtkl LGTK liveness bit field
