...
// Core
  ...
  EMBER_GET_INT32U_MILLISECOND_TICK_IPC_COMMAND_ID                     = VNCP_CMD_ID + 0x51,
  EMBER_GET_VERSION_INFO_IPC_COMMAND_ID                                = VNCP_CMD_ID + 0x53,
  EMBER_OFDM_SET_MCS_IPC_COMMAND_ID                                    = VNCP_CMD_ID + 0x54,
  EMBER_OFDM_GET_MCS_IPC_COMMAND_ID                                    = VNCP_CMD_ID + 0x55,
  EMBER_NCP_SET_LONG_MESSAGES_USE_IPC_COMMAND_ID                       = VNCP_CMD_ID + 0x56,
  EMBER_USING_LONG_MESSAGES_IPC_COMMAND_ID                             = VNCP_CMD_ID + 0x57,
  EMBER_SET_RADIO_PRIORITY_IPC_COMMAND_ID                              = VNCP_CMD_ID + 0x59,
  EMBER_GET_RADIO_PRIORITY_IPC_COMMAND_ID                              = VNCP_CMD_ID + 0x5A,
