...
bool
cc_multilevel_sensor_endpoint_0_humidity_interface_init(void)
{
  return MultilevelSensor_temperature_humidity_sensor_init();
}

bool
cc_multilevel_sensor_endpoint_0_air_temperature_interface_init(void)
{
  return MultilevelSensor_temperature_humidity_sensor_init();
}
...
bool
cc_multilevel_sensor_endpoint_0_humidity_interface_deinit(void)
{
  return MultilevelSensor_temperature_humidity_sensor_deinit();
}

bool
cc_multilevel_sensor_endpoint_0_air_temperature_interface_deinit(void)
{
  return MultilevelSensor_temperature_humidity_sensor_deinit();
}
...
bool
cc_multilevel_sensor_endpoint_0_humidity_interface_read_value(sensor_read_result_t* o_result, __attribute__((unused)) uint8_t i_scale)
{
  uint32_t rh_data;
  int32_t temp_data;
...
bool
cc_multilevel_sensor_endpoint_0_air_temperature_interface_read_value(sensor_read_result_t* o_result, uint8_t i_scale)
{
  uint32_t rh_data;
