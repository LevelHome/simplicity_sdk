...
#if 1 // Change the value to 0 when you have verified the configuration to suppress this warning.
#warning "Bootloader UART peripherals are on default config, which might be incorrect for custom boards!"
#endif
