 ...
 *
 *****************************************************************************/
#ifndef MGM220PC22HNA_H
#define MGM220PC22HNA_H
...
/**************************************************************************//**
 * @defgroup MGM220PC22HNA MGM220PC22HNA
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  MGM22 Peripheral Interrupt Numbers ******************************************/
...
/**************************************************************************//**
 * @defgroup MGM220PC22HNA_Core MGM220PC22HNA Core
 * @{
...
/** @} End of group MGM220PC22HNA_Core */

/**************************************************************************//**
* @defgroup MGM220PC22HNA_Part MGM220PC22HNA Part
* @{
******************************************************************************/
...
#if !defined(MGM220PC22HNA)
#define MGM220PC22HNA    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                       "MGM220PC22HNA" /**< Part Number */
...
/** Flash and SRAM limits for MGM220PC22HNA */
...
#include "system_mgm22.h" /* System Header File */

/** @} End of group MGM220PC22HNA_Part */

/**************************************************************************//**
 * @defgroup MGM220PC22HNA_Peripheral_TypeDefs MGM220PC22HNA Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "mgm22_emu.h"
#include "mgm22_cmu.h"
#include "mgm22_hfxo.h"
#include "mgm22_hfrco.h"
#include "mgm22_fsrco.h"
#include "mgm22_dpll.h"
#include "mgm22_lfxo.h"
#include "mgm22_lfrco.h"
#include "mgm22_ulfrco.h"
#include "mgm22_msc.h"
#include "mgm22_icache.h"
#include "mgm22_prs.h"
#include "mgm22_gpio.h"
#include "mgm22_ldma.h"
#include "mgm22_ldmaxbar.h"
#include "mgm22_timer.h"
#include "mgm22_usart.h"
#include "mgm22_burtc.h"
#include "mgm22_i2c.h"
#include "mgm22_syscfg.h"
#include "mgm22_buram.h"
#include "mgm22_gpcrc.h"
#include "mgm22_dcdc.h"
#include "mgm22_pdm.h"
#include "mgm22_aes.h"
#include "mgm22_smu.h"
#include "mgm22_rtcc.h"
#include "mgm22_letimer.h"
#include "mgm22_iadc.h"
#include "mgm22_wdog.h"
#include "mgm22_eusart.h"
#include "mgm22_cryptoacc.h"
#include "mgm22_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "mgm22_prs_signals.h"
#include "mgm22_dma_descriptor.h"
#include "mgm22_ldmaxbar_defines.h"

/** @} End of group MGM220PC22HNA_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup MGM220PC22HNA_Peripheral_Base MGM220PC22HNA Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group MGM220PC22HNA_Peripheral_Base */

/**************************************************************************//**
 * @defgroup MGM220PC22HNA_Peripheral_Declaration MGM220PC22HNA Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group MGM220PC22HNA_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup MGM220PC22HNA_Peripheral_Parameters MGM220PC22HNA Peripheral Parameters
 * @{
...
/** @} End of group MGM220PC22HNA_Peripheral_Parameters  */

/** @} End of group MGM220PC22HNA */
/** @}} End of group Parts */
