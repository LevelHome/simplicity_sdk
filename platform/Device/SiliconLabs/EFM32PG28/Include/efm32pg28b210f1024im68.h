 ...
 *
 *****************************************************************************/
#ifndef EFM32PG28B210F1024IM68_H
#define EFM32PG28B210F1024IM68_H
...
/**************************************************************************//**
 * @defgroup EFM32PG28B210F1024IM68 EFM32PG28B210F1024IM68
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  EFM32PG28 Peripheral Interrupt Numbers ******************************************/
  ...
  VDAC0_IRQn             = 55, /*!< 55 EFM32 VDAC0 Interrupt */
  ...
  AHB2AHB0_IRQn          = 76, /*!< 76 EFM32 AHB2AHB0 Interrupt */
  AHB2AHB1_IRQn          = 77, /*!< 77 EFM32 AHB2AHB1 Interrupt */
  MVP_IRQn               = 78, /*!< 78 EFM32 MVP Interrupt */
} IRQn_Type;

/**************************************************************************//**
 * @defgroup EFM32PG28B210F1024IM68_Core EFM32PG28B210F1024IM68 Core
 * @{
...
/** @} End of group EFM32PG28B210F1024IM68_Core */

/**************************************************************************//**
* @defgroup EFM32PG28B210F1024IM68_Part EFM32PG28B210F1024IM68 Part
* @{
******************************************************************************/
...
#if !defined(EFM32PG28B210F1024IM68)
#define EFM32PG28B210F1024IM68    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                              "EFM32PG28B210F1024IM68" /**< Part Number */
...
/** Flash and SRAM limits for EFM32PG28B210F1024IM68 */
...
#define GPIO_PA_COUNT                            15U        /**< Number of pins on port PA */
#define GPIO_PA_MASK                             (0x7FFFUL) /**< Port PA pin mask */
...
#define GPIO_PB_COUNT                            8U         /**< Number of pins on port PB */
#define GPIO_PB_MASK                             (0x00FFUL) /**< Port PB pin mask */
...
#define GPIO_PC_COUNT                            12U        /**< Number of pins on port PC */
#define GPIO_PC_MASK                             (0x0FFFUL) /**< Port PC pin mask */
...
#define GPIO_THMSW_EN_PIN                        11U           /**< Pin of THMSW_EN.*/
#define GPIO_THMSW_HALFSWITCH_PORT               GPIO_PC_INDEX /**< Port of THMSW_HALFSWITCH.*/
#define GPIO_THMSW_HALFSWITCH_PIN                11U           /**< Pin of THMSW_HALFSWITCH.*/
...
#define LCD_COM4_PORT                            GPIO_PA_INDEX /**< Port of COM4.*/
#define LCD_COM4_PIN                             13U           /**< Pin of COM4.*/
#define LCD_COM5_PORT                            GPIO_PA_INDEX /**< Port of COM5.*/
#define LCD_COM5_PIN                             14U           /**< Pin of COM5.*/
#define LCD_COM6_PORT                            GPIO_PB_INDEX /**< Port of COM6.*/
#define LCD_COM6_PIN                             4U            /**< Pin of COM6.*/
#define LCD_COM7_PORT                            GPIO_PB_INDEX /**< Port of COM7.*/
#define LCD_COM7_PIN                             5U            /**< Pin of COM7.*/
...
#include "system_efm32pg28.h" /* System Header File */

/** @} End of group EFM32PG28B210F1024IM68_Part */

/**************************************************************************//**
 * @defgroup EFM32PG28B210F1024IM68_Peripheral_TypeDefs EFM32PG28B210F1024IM68 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "efm32pg28_scratchpad.h"
#include "efm32pg28_emu.h"
#include "efm32pg28_cmu.h"
#include "efm32pg28_hfrco.h"
#include "efm32pg28_fsrco.h"
#include "efm32pg28_dpll.h"
#include "efm32pg28_lfxo.h"
#include "efm32pg28_lfrco.h"
#include "efm32pg28_ulfrco.h"
#include "efm32pg28_msc.h"
#include "efm32pg28_icache.h"
#include "efm32pg28_prs.h"
#include "efm32pg28_gpio.h"
#include "efm32pg28_ldma.h"
#include "efm32pg28_ldmaxbar.h"
#include "efm32pg28_timer.h"
#include "efm32pg28_usart.h"
#include "efm32pg28_burtc.h"
#include "efm32pg28_i2c.h"
#include "efm32pg28_syscfg.h"
#include "efm32pg28_buram.h"
#include "efm32pg28_gpcrc.h"
#include "efm32pg28_dcdc.h"
#include "efm32pg28_mailbox.h"
#include "efm32pg28_eusart.h"
#include "efm32pg28_sysrtc.h"
#include "efm32pg28_lcd.h"
#include "efm32pg28_keyscan.h"
#include "efm32pg28_mpahbram.h"
#include "efm32pg28_smu.h"
#include "efm32pg28_letimer.h"
#include "efm32pg28_iadc.h"
#include "efm32pg28_acmp.h"
#include "efm32pg28_vdac.h"
#include "efm32pg28_pcnt.h"
#include "efm32pg28_lesense.h"
#include "efm32pg28_hfxo.h"
#include "efm32pg28_wdog.h"
#include "efm32pg28_semailbox.h"
#include "efm32pg28_mvp.h"
#include "efm32pg28_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "efm32pg28_prs_signals.h"
#include "efm32pg28_dma_descriptor.h"
#include "efm32pg28_ldmaxbar_defines.h"

/** @} End of group EFM32PG28B210F1024IM68_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFM32PG28B210F1024IM68_Peripheral_Base EFM32PG28B210F1024IM68 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32PG28B210F1024IM68_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFM32PG28B210F1024IM68_Peripheral_Declaration EFM32PG28B210F1024IM68 Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32PG28B210F1024IM68_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFM32PG28B210F1024IM68_Peripheral_Parameters EFM32PG28B210F1024IM68 Peripheral Parameters
 * @{
...
/** @} End of group EFM32PG28B210F1024IM68_Peripheral_Parameters  */

/** @} End of group EFM32PG28B210F1024IM68 */
/** @}} End of group Parts */
