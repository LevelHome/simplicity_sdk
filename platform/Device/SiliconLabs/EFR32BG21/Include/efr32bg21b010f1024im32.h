 ...
 *
 *****************************************************************************/
#ifndef EFR32BG21B010F1024IM32_H
#define EFR32BG21B010F1024IM32_H
...
/**************************************************************************//**
 * @defgroup EFR32BG21B010F1024IM32 EFR32BG21B010F1024IM32
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  EFR32BG21 Peripheral Interrupt Numbers ******************************************/
...
/**************************************************************************//**
 * @defgroup EFR32BG21B010F1024IM32_Core EFR32BG21B010F1024IM32 Core
 * @{
...
/** @} End of group EFR32BG21B010F1024IM32_Core */

/**************************************************************************//**
* @defgroup EFR32BG21B010F1024IM32_Part EFR32BG21B010F1024IM32 Part
* @{
******************************************************************************/
...
#if !defined(EFR32BG21B010F1024IM32)
#define EFR32BG21B010F1024IM32    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                       "EFR32BG21B010F1024IM32" /**< Part Number */
...
/** Flash and SRAM limits for EFR32BG21B010F1024IM32 */
...
#define SRAM_SIZE                                         (0x00018000UL) /**< Available SRAM Memory */
...
#include "system_efr32bg21.h" /* System Header File */

/** @} End of group EFR32BG21B010F1024IM32_Part */

/**************************************************************************//**
 * @defgroup EFR32BG21B010F1024IM32_Peripheral_TypeDefs EFR32BG21B010F1024IM32 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "efr32bg21_emu.h"
#include "efr32bg21_cmu.h"
#include "efr32bg21_hfxo.h"
#include "efr32bg21_hfrco.h"
#include "efr32bg21_fsrco.h"
#include "efr32bg21_dpll.h"
#include "efr32bg21_lfxo.h"
#include "efr32bg21_lfrco.h"
#include "efr32bg21_ulfrco.h"
#include "efr32bg21_msc.h"
#include "efr32bg21_icache.h"
#include "efr32bg21_prs.h"
#include "efr32bg21_gpio.h"
#include "efr32bg21_ldma.h"
#include "efr32bg21_ldmaxbar.h"
#include "efr32bg21_timer.h"
#include "efr32bg21_usart.h"
#include "efr32bg21_burtc.h"
#include "efr32bg21_i2c.h"
#include "efr32bg21_lvgd.h"
#include "efr32bg21_syscfg.h"
#include "efr32bg21_buram.h"
#include "efr32bg21_gpcrc.h"
#include "efr32bg21_aes.h"
#include "efr32bg21_bufc.h"
#include "efr32bg21_smu.h"
#include "efr32bg21_rtcc.h"
#include "efr32bg21_letimer.h"
#include "efr32bg21_iadc.h"
#include "efr32bg21_acmp.h"
#include "efr32bg21_wdog.h"
#include "efr32bg21_semailbox.h"
#include "efr32bg21_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "efr32bg21_prs_signals.h"
#include "efr32bg21_dma_descriptor.h"
#include "efr32bg21_ldmaxbar_defines.h"

/** @} End of group EFR32BG21B010F1024IM32_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32BG21B010F1024IM32_Peripheral_Base EFR32BG21B010F1024IM32 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32BG21B010F1024IM32_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32BG21B010F1024IM32_Peripheral_Declaration EFR32BG21B010F1024IM32 Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32BG21B010F1024IM32_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32BG21B010F1024IM32_Peripheral_Parameters EFR32BG21B010F1024IM32 Peripheral Parameters
 * @{
...
/** @} End of group EFR32BG21B010F1024IM32_Peripheral_Parameters  */

/** @} End of group EFR32BG21B010F1024IM32 */
/** @}} End of group Parts */
