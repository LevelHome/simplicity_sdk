/**************************************************************************//**
 * @file
 * @brief EFR32MG27 SYSCFG register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32MG27_SYSCFG_H
#define EFR32MG27_SYSCFG_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32MG27_SYSCFG SYSCFG
 * @{
 * @brief EFR32MG27 SYSCFG Register Declaration.
 *****************************************************************************/
...
typedef struct syscfg_typedef{
  ...
  uint32_t       RESERVED7[61U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED11[121U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED12[636U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED20[61U];               /**< Reserved for future use                            */
  __IOM uint32_t RAMBIASCONF_SET;               /**< RAM Bias Configuration                             */
  uint32_t       RESERVED21[60U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED25[636U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED33[61U];               /**< Reserved for future use                            */
  __IOM uint32_t RAMBIASCONF_CLR;               /**< RAM Bias Configuration                             */
  uint32_t       RESERVED34[60U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED37[121U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED38[636U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED46[61U];               /**< Reserved for future use                            */
  __IOM uint32_t RAMBIASCONF_TGL;               /**< RAM Bias Configuration                             */
  uint32_t       RESERVED47[60U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED50[121U];              /**< Reserved for future use                            */
...
/** @} End of group EFR32MG27_SYSCFG */

/**************************************************************************//**
 * @addtogroup EFR32MG27_SYSCFG
 * @{
 * @defgroup EFR32MG27_SYSCFG_BitFields SYSCFG Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for SYSCFG IPVERSION */
#define _SYSCFG_IPVERSION_RESETVALUE                       0x00000005UL                               /**< Default value for SYSCFG_IPVERSION          */
...
#define _SYSCFG_IPVERSION_IPVERSION_DEFAULT                0x00000005UL                               /**< Mode DEFAULT for SYSCFG_IPVERSION           */
...
#define _SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0TO1          0x00000003UL                                      /**< Mode BLK0TO1 for SYSCFG_DMEM0RETNCTRL       */
#define _SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK2             0x00000004UL                                      /**< Mode BLK2 for SYSCFG_DMEM0RETNCTRL          */
#define _SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0AND2         0x00000005UL                                      /**< Mode BLK0AND2 for SYSCFG_DMEM0RETNCTRL      */
#define _SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK1TO2          0x00000006UL                                      /**< Mode BLK1TO2 for SYSCFG_DMEM0RETNCTRL       */
#define _SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0TO2          0x00000007UL                                      /**< Mode BLK0TO2 for SYSCFG_DMEM0RETNCTRL       */
...
#define SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0TO1           (_SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0TO1 << 0)  /**< Shifted mode BLK0TO1 for SYSCFG_DMEM0RETNCTRL*/
#define SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK2              (_SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK2 << 0)     /**< Shifted mode BLK2 for SYSCFG_DMEM0RETNCTRL  */
#define SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0AND2          (_SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0AND2 << 0) /**< Shifted mode BLK0AND2 for SYSCFG_DMEM0RETNCTRL*/
#define SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK1TO2           (_SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK1TO2 << 0)  /**< Shifted mode BLK1TO2 for SYSCFG_DMEM0RETNCTRL*/
#define SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0TO2           (_SYSCFG_DMEM0RETNCTRL_RAMRETNCTRL_BLK0TO2 << 0)  /**< Shifted mode BLK0TO2 for SYSCFG_DMEM0RETNCTRL*/
...
#define _SYSCFG_ROOTLOCKSTATUS_MASK                        0x811F0117UL                                         /**< Mask for SYSCFG_ROOTLOCKSTATUS              */
...
/** @} End of group EFR32MG27_SYSCFG_BitFields */
/** @} End of group EFR32MG27_SYSCFG */
/**************************************************************************//**
 * @defgroup EFR32MG27_SYSCFG_CFGNS SYSCFG_CFGNS
 * @{
 * @brief EFR32MG27 SYSCFG_CFGNS Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFR32MG27_SYSCFG_CFGNS */

/**************************************************************************//**
 * @addtogroup EFR32MG27_SYSCFG_CFGNS
 * @{
 * @defgroup EFR32MG27_SYSCFG_CFGNS_BitFields SYSCFG_CFGNS Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG27_SYSCFG_CFGNS_BitFields */
/** @} End of group EFR32MG27_SYSCFG_CFGNS */
/** @} End of group Parts */

#endif // EFR32MG27_SYSCFG_H
