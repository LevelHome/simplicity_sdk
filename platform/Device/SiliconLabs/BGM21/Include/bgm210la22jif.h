 ...
 *
 *****************************************************************************/
#ifndef BGM210LA22JIF_H
#define BGM210LA22JIF_H
...
/**************************************************************************//**
 * @defgroup BGM210LA22JIF BGM210LA22JIF
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  BGM21 Peripheral Interrupt Numbers ******************************************/
...
/**************************************************************************//**
 * @defgroup BGM210LA22JIF_Core BGM210LA22JIF Core
 * @{
...
/** @} End of group BGM210LA22JIF_Core */

/**************************************************************************//**
* @defgroup BGM210LA22JIF_Part BGM210LA22JIF Part
* @{
******************************************************************************/
...
#if !defined(BGM210LA22JIF)
#define BGM210LA22JIF    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                       "BGM210LA22JIF" /**< Part Number */
...
#define _SILICON_LABS_EFR32_2G4HZ_HP_PA_MAX_OUTPUT_DBM    12                                 /** Radio 2G4HZ HP PA output power */
...
/** Flash and SRAM limits for BGM210LA22JIF */
...
#define GPIO_PA_COUNT                                     4U         /**< Number of pins on port PA */
#define GPIO_PA_MASK                                      (0x001EUL) /**< Port PA pin mask */
...
#define GPIO_PB_COUNT                                     0U         /**< Number of pins on port PB */
#define GPIO_PB_MASK                                      (0x0000UL) /**< Port PB pin mask */
...
#include "system_bgm21.h" /* System Header File */

/** @} End of group BGM210LA22JIF_Part */

/**************************************************************************//**
 * @defgroup BGM210LA22JIF_Peripheral_TypeDefs BGM210LA22JIF Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "bgm21_emu.h"
#include "bgm21_cmu.h"
#include "bgm21_hfxo.h"
#include "bgm21_hfrco.h"
#include "bgm21_fsrco.h"
#include "bgm21_dpll.h"
#include "bgm21_lfxo.h"
#include "bgm21_lfrco.h"
#include "bgm21_ulfrco.h"
#include "bgm21_msc.h"
#include "bgm21_icache.h"
#include "bgm21_prs.h"
#include "bgm21_gpio.h"
#include "bgm21_ldma.h"
#include "bgm21_ldmaxbar.h"
#include "bgm21_timer.h"
#include "bgm21_usart.h"
#include "bgm21_burtc.h"
#include "bgm21_i2c.h"
#include "bgm21_lvgd.h"
#include "bgm21_syscfg.h"
#include "bgm21_buram.h"
#include "bgm21_gpcrc.h"
#include "bgm21_aes.h"
#include "bgm21_bufc.h"
#include "bgm21_smu.h"
#include "bgm21_rtcc.h"
#include "bgm21_letimer.h"
#include "bgm21_iadc.h"
#include "bgm21_acmp.h"
#include "bgm21_wdog.h"
#include "bgm21_semailbox.h"
#include "bgm21_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "bgm21_prs_signals.h"
#include "bgm21_dma_descriptor.h"
#include "bgm21_ldmaxbar_defines.h"

/** @} End of group BGM210LA22JIF_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup BGM210LA22JIF_Peripheral_Base BGM210LA22JIF Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group BGM210LA22JIF_Peripheral_Base */

/**************************************************************************//**
 * @defgroup BGM210LA22JIF_Peripheral_Declaration BGM210LA22JIF Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group BGM210LA22JIF_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup BGM210LA22JIF_Peripheral_Parameters BGM210LA22JIF Peripheral Parameters
 * @{
...
/** @} End of group BGM210LA22JIF_Peripheral_Parameters  */

/** @} End of group BGM210LA22JIF */
/** @}} End of group Parts */
