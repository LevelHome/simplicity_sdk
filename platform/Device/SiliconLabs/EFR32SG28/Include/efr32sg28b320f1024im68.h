 ...
 *
 *****************************************************************************/
#ifndef EFR32SG28B320F1024IM68_H
#define EFR32SG28B320F1024IM68_H
...
/**************************************************************************//**
 * @defgroup EFR32SG28B320F1024IM68 EFR32SG28B320F1024IM68
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  EFR32SG28 Peripheral Interrupt Numbers ******************************************/
...
/**************************************************************************//**
 * @defgroup EFR32SG28B320F1024IM68_Core EFR32SG28B320F1024IM68 Core
 * @{
...
/** @} End of group EFR32SG28B320F1024IM68_Core */

/**************************************************************************//**
* @defgroup EFR32SG28B320F1024IM68_Part EFR32SG28B320F1024IM68 Part
* @{
******************************************************************************/
...
#if !defined(EFR32SG28B320F1024IM68)
#define EFR32SG28B320F1024IM68    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                        "EFR32SG28B320F1024IM68" /**< Part Number */

/** Family / Line / Series / Config */
#define _EFR32_SIDEWALK_FAMILY                             1                                    /** Device Family Name Identifier */
#define _EFR32_SG_FAMILY                                   1                                    /** Device Family Identifier */
...
/** Flash and SRAM limits for EFR32SG28B320F1024IM68 */
...
#include "system_efr32sg28.h" /* System Header File */

/** @} End of group EFR32SG28B320F1024IM68_Part */

/**************************************************************************//**
 * @defgroup EFR32SG28B320F1024IM68_Peripheral_TypeDefs EFR32SG28B320F1024IM68 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "efr32sg28_scratchpad.h"
#include "efr32sg28_emu.h"
#include "efr32sg28_cmu.h"
#include "efr32sg28_hfrco.h"
#include "efr32sg28_fsrco.h"
#include "efr32sg28_dpll.h"
#include "efr32sg28_lfxo.h"
#include "efr32sg28_lfrco.h"
#include "efr32sg28_ulfrco.h"
#include "efr32sg28_msc.h"
#include "efr32sg28_icache.h"
#include "efr32sg28_prs.h"
#include "efr32sg28_gpio.h"
#include "efr32sg28_ldma.h"
#include "efr32sg28_ldmaxbar.h"
#include "efr32sg28_timer.h"
#include "efr32sg28_usart.h"
#include "efr32sg28_burtc.h"
#include "efr32sg28_i2c.h"
#include "efr32sg28_syscfg.h"
#include "efr32sg28_buram.h"
#include "efr32sg28_gpcrc.h"
#include "efr32sg28_dcdc.h"
#include "efr32sg28_mailbox.h"
#include "efr32sg28_eusart.h"
#include "efr32sg28_sysrtc.h"
#include "efr32sg28_lcd.h"
#include "efr32sg28_keyscan.h"
#include "efr32sg28_mpahbram.h"
#include "efr32sg28_lcdrf.h"
#include "efr32sg28_pfmxpprf.h"
#include "efr32sg28_aes.h"
#include "efr32sg28_smu.h"
#include "efr32sg28_letimer.h"
#include "efr32sg28_iadc.h"
#include "efr32sg28_acmp.h"
#include "efr32sg28_vdac.h"
#include "efr32sg28_pcnt.h"
#include "efr32sg28_lesense.h"
#include "efr32sg28_hfxo.h"
#include "efr32sg28_wdog.h"
#include "efr32sg28_semailbox.h"
#include "efr32sg28_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "efr32sg28_prs_signals.h"
#include "efr32sg28_dma_descriptor.h"
#include "efr32sg28_ldmaxbar_defines.h"

/** @} End of group EFR32SG28B320F1024IM68_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32SG28B320F1024IM68_Peripheral_Base EFR32SG28B320F1024IM68 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32SG28B320F1024IM68_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32SG28B320F1024IM68_Peripheral_Declaration EFR32SG28B320F1024IM68 Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32SG28B320F1024IM68_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32SG28B320F1024IM68_Peripheral_Parameters EFR32SG28B320F1024IM68 Peripheral Parameters
 * @{
...
/** @} End of group EFR32SG28B320F1024IM68_Peripheral_Parameters  */

/** @} End of group EFR32SG28B320F1024IM68 */
/** @}} End of group Parts */
