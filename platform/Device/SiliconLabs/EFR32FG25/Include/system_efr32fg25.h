/**************************************************************************//**
 * @file
 * @brief CMSIS system header file for EFR32FG25
 ******************************************************************************
 * # License
...
#ifndef SYSTEM_EFR32FG25_H
#define SYSTEM_EFR32FG25_H
 ...
 ******************************************************************************/
/***************************************************************************//**
 * @addtogroup EFR32FG25 EFR32FG25
 * @{
 ******************************************************************************/
...
void TIMER7_IRQHandler(void);            /**< TIMER7 IRQ Handler */
...
void EUSART3_RX_IRQHandler(void);        /**< EUSART3_RX IRQ Handler */
void EUSART3_TX_IRQHandler(void);        /**< EUSART3_TX IRQ Handler */
void EUSART4_RX_IRQHandler(void);        /**< EUSART4_RX IRQ Handler */
void EUSART4_TX_IRQHandler(void);        /**< EUSART4_TX IRQ Handler */
...
void RFFPLL_IRQHandler(void);            /**< RFFPLL IRQ Handler */
void USBPLL0_IRQHandler(void);           /**< USBPLL0 IRQ Handler */
void AHB2AHB0_IRQHandler(void);          /**< AHB2AHB0 IRQ Handler */
void AHB2AHB1_IRQHandler(void);          /**< AHB2AHB1 IRQ Handler */
void AHB2AHB2_IRQHandler(void);          /**< AHB2AHB2 IRQ Handler */
void AHB2AHB3_IRQHandler(void);          /**< AHB2AHB3 IRQ Handler */
void RFTIMER_IRQHandler(void);           /**< RFTIMER IRQ Handler */
void SOFTM_IRQHandler(void);             /**< SOFTM IRQ Handler */
void RFLDMA_IRQHandler(void);            /**< RFLDMA IRQ Handler */
