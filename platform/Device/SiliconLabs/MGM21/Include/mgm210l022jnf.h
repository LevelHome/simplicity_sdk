 ...
 *
 *****************************************************************************/
#ifndef MGM210L022JNF_H
#define MGM210L022JNF_H
...
/**************************************************************************//**
 * @defgroup MGM210L022JNF MGM210L022JNF
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  MGM21 Peripheral Interrupt Numbers ******************************************/
...
/**************************************************************************//**
 * @defgroup MGM210L022JNF_Core MGM210L022JNF Core
 * @{
...
/** @} End of group MGM210L022JNF_Core */

/**************************************************************************//**
* @defgroup MGM210L022JNF_Part MGM210L022JNF Part
* @{
******************************************************************************/
...
#if !defined(MGM210L022JNF)
#define MGM210L022JNF    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                       "MGM210L022JNF" /**< Part Number */
...
/** Flash and SRAM limits for MGM210L022JNF */
...
#include "system_mgm21.h" /* System Header File */

/** @} End of group MGM210L022JNF_Part */

/**************************************************************************//**
 * @defgroup MGM210L022JNF_Peripheral_TypeDefs MGM210L022JNF Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "mgm21_emu.h"
#include "mgm21_cmu.h"
#include "mgm21_hfxo.h"
#include "mgm21_hfrco.h"
#include "mgm21_fsrco.h"
#include "mgm21_dpll.h"
#include "mgm21_lfxo.h"
#include "mgm21_lfrco.h"
#include "mgm21_ulfrco.h"
#include "mgm21_msc.h"
#include "mgm21_icache.h"
#include "mgm21_prs.h"
#include "mgm21_gpio.h"
#include "mgm21_ldma.h"
#include "mgm21_ldmaxbar.h"
#include "mgm21_timer.h"
#include "mgm21_usart.h"
#include "mgm21_burtc.h"
#include "mgm21_i2c.h"
#include "mgm21_lvgd.h"
#include "mgm21_syscfg.h"
#include "mgm21_buram.h"
#include "mgm21_gpcrc.h"
#include "mgm21_aes.h"
#include "mgm21_bufc.h"
#include "mgm21_smu.h"
#include "mgm21_rtcc.h"
#include "mgm21_letimer.h"
#include "mgm21_iadc.h"
#include "mgm21_acmp.h"
#include "mgm21_wdog.h"
#include "mgm21_semailbox.h"
#include "mgm21_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "mgm21_prs_signals.h"
#include "mgm21_dma_descriptor.h"
#include "mgm21_ldmaxbar_defines.h"

/** @} End of group MGM210L022JNF_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup MGM210L022JNF_Peripheral_Base MGM210L022JNF Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group MGM210L022JNF_Peripheral_Base */

/**************************************************************************//**
 * @defgroup MGM210L022JNF_Peripheral_Declaration MGM210L022JNF Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group MGM210L022JNF_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup MGM210L022JNF_Peripheral_Parameters MGM210L022JNF Peripheral Parameters
 * @{
...
/** @} End of group MGM210L022JNF_Peripheral_Parameters  */

/** @} End of group MGM210L022JNF */
/** @}} End of group Parts */
