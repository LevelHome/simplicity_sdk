/**************************************************************************//**
 * @file
 * @brief MGM26 GPIO Port register and bit field definitions
 ******************************************************************************
 * # License
...
#define _GPIO_P_MODEH_MODE7_SHIFT                      28                                                  /**< Shift value for GPIO_MODE7                  */
#define _GPIO_P_MODEH_MODE7_MASK                       0xF0000000UL                                        /**< Bit mask for GPIO_MODE7                     */
#define _GPIO_P_MODEH_MODE7_DEFAULT                    0x00000000UL                                        /**< Mode DEFAULT for GPIO_P_MODEH               */
#define _GPIO_P_MODEH_MODE7_DISABLED                   0x00000000UL                                        /**< Mode DISABLED for GPIO_P_MODEH              */
#define _GPIO_P_MODEH_MODE7_INPUT                      0x00000001UL                                        /**< Mode INPUT for GPIO_P_MODEH                 */
#define _GPIO_P_MODEH_MODE7_INPUTPULL                  0x00000002UL                                        /**< Mode INPUTPULL for GPIO_P_MODEH             */
#define _GPIO_P_MODEH_MODE7_INPUTPULLFILTER            0x00000003UL                                        /**< Mode INPUTPULLFILTER for GPIO_P_MODEH       */
#define _GPIO_P_MODEH_MODE7_PUSHPULL                   0x00000004UL                                        /**< Mode PUSHPULL for GPIO_P_MODEH              */
#define _GPIO_P_MODEH_MODE7_PUSHPULLALT                0x00000005UL                                        /**< Mode PUSHPULLALT for GPIO_P_MODEH           */
#define _GPIO_P_MODEH_MODE7_WIREDOR                    0x00000006UL                                        /**< Mode WIREDOR for GPIO_P_MODEH               */
#define _GPIO_P_MODEH_MODE7_WIREDORPULLDOWN            0x00000007UL                                        /**< Mode WIREDORPULLDOWN for GPIO_P_MODEH       */
#define _GPIO_P_MODEH_MODE7_WIREDAND                   0x00000008UL                                        /**< Mode WIREDAND for GPIO_P_MODEH              */
#define _GPIO_P_MODEH_MODE7_WIREDANDFILTER             0x00000009UL                                        /**< Mode WIREDANDFILTER for GPIO_P_MODEH        */
#define _GPIO_P_MODEH_MODE7_WIREDANDPULLUP             0x0000000AUL                                        /**< Mode WIREDANDPULLUP for GPIO_P_MODEH        */
#define _GPIO_P_MODEH_MODE7_WIREDANDPULLUPFILTER       0x0000000BUL                                        /**< Mode WIREDANDPULLUPFILTER for GPIO_P_MODEH  */
#define _GPIO_P_MODEH_MODE7_WIREDANDALT                0x0000000CUL                                        /**< Mode WIREDANDALT for GPIO_P_MODEH           */
#define _GPIO_P_MODEH_MODE7_WIREDANDALTFILTER          0x0000000DUL                                        /**< Mode WIREDANDALTFILTER for GPIO_P_MODEH     */
#define _GPIO_P_MODEH_MODE7_WIREDANDALTPULLUP          0x0000000EUL                                        /**< Mode WIREDANDALTPULLUP for GPIO_P_MODEH     */
#define _GPIO_P_MODEH_MODE7_WIREDANDALTPULLUPFILTER    0x0000000FUL                                        /**< Mode WIREDANDALTPULLUPFILTER for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_DEFAULT                     (_GPIO_P_MODEH_MODE7_DEFAULT << 28)                 /**< Shifted mode DEFAULT for GPIO_P_MODEH       */
#define GPIO_P_MODEH_MODE7_DISABLED                    (_GPIO_P_MODEH_MODE7_DISABLED << 28)                /**< Shifted mode DISABLED for GPIO_P_MODEH      */
#define GPIO_P_MODEH_MODE7_INPUT                       (_GPIO_P_MODEH_MODE7_INPUT << 28)                   /**< Shifted mode INPUT for GPIO_P_MODEH         */
#define GPIO_P_MODEH_MODE7_INPUTPULL                   (_GPIO_P_MODEH_MODE7_INPUTPULL << 28)               /**< Shifted mode INPUTPULL for GPIO_P_MODEH     */
#define GPIO_P_MODEH_MODE7_INPUTPULLFILTER             (_GPIO_P_MODEH_MODE7_INPUTPULLFILTER << 28)         /**< Shifted mode INPUTPULLFILTER for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_PUSHPULL                    (_GPIO_P_MODEH_MODE7_PUSHPULL << 28)                /**< Shifted mode PUSHPULL for GPIO_P_MODEH      */
#define GPIO_P_MODEH_MODE7_PUSHPULLALT                 (_GPIO_P_MODEH_MODE7_PUSHPULLALT << 28)             /**< Shifted mode PUSHPULLALT for GPIO_P_MODEH   */
#define GPIO_P_MODEH_MODE7_WIREDOR                     (_GPIO_P_MODEH_MODE7_WIREDOR << 28)                 /**< Shifted mode WIREDOR for GPIO_P_MODEH       */
#define GPIO_P_MODEH_MODE7_WIREDORPULLDOWN             (_GPIO_P_MODEH_MODE7_WIREDORPULLDOWN << 28)         /**< Shifted mode WIREDORPULLDOWN for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_WIREDAND                    (_GPIO_P_MODEH_MODE7_WIREDAND << 28)                /**< Shifted mode WIREDAND for GPIO_P_MODEH      */
#define GPIO_P_MODEH_MODE7_WIREDANDFILTER              (_GPIO_P_MODEH_MODE7_WIREDANDFILTER << 28)          /**< Shifted mode WIREDANDFILTER for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_WIREDANDPULLUP              (_GPIO_P_MODEH_MODE7_WIREDANDPULLUP << 28)          /**< Shifted mode WIREDANDPULLUP for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_WIREDANDPULLUPFILTER        (_GPIO_P_MODEH_MODE7_WIREDANDPULLUPFILTER << 28)    /**< Shifted mode WIREDANDPULLUPFILTER for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_WIREDANDALT                 (_GPIO_P_MODEH_MODE7_WIREDANDALT << 28)             /**< Shifted mode WIREDANDALT for GPIO_P_MODEH   */
#define GPIO_P_MODEH_MODE7_WIREDANDALTFILTER           (_GPIO_P_MODEH_MODE7_WIREDANDALTFILTER << 28)       /**< Shifted mode WIREDANDALTFILTER for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_WIREDANDALTPULLUP           (_GPIO_P_MODEH_MODE7_WIREDANDALTPULLUP << 28)       /**< Shifted mode WIREDANDALTPULLUP for GPIO_P_MODEH*/
#define GPIO_P_MODEH_MODE7_WIREDANDALTPULLUPFILTER     (_GPIO_P_MODEH_MODE7_WIREDANDALTPULLUPFILTER << 28) /**< Shifted mode WIREDANDALTPULLUPFILTER for GPIO_P_MODEH*/
