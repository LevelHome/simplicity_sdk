...
const uint32_t sl_rail_ble_phy_1Mbps_viterbi_40MHz_0_37_modemConfig[] = {
...
const uint32_t sl_rail_ble_phy_2Mbps_viterbi_40MHz_0_37_modemConfig[] = {
...
const uint32_t sl_rail_ble_phy_2Mbps_aox_40MHz_0_34_modemConfig[] = {
  0x03014FFCUL, (uint32_t) &phyInfo_1,
  0x00014010UL, 0x00004101UL,
  0x0001403CUL, 0x00000000UL,
  0x00014048UL, 0x030007A0UL,
...
const uint32_t sl_rail_ble_phy_125kbps_40MHz_0_37_modemConfig[] = {
...
const uint32_t sl_rail_ble_phy_500kbps_40MHz_0_37_modemConfig[] = {
...
const RAIL_ChannelConfigEntry_t sl_rail_ble_phy_2Mbps_aox_40MHz_channels[] = {
  {
...
const RAIL_ChannelConfig_t sl_rail_ble_phy_1Mbps_viterbi_cs_40MHz_channelConfig = {
  ...
  .phyConfigDeltaSubtract = NULL,
  .configs = sl_rail_ble_phy_1Mbps_viterbi_cs_40MHz_channels,
  .length = 1U,
  .signature = 0UL,
  .xtalFrequencyHz = 40000000UL,
};
...
const RAIL_ChannelConfig_t sl_rail_ble_phy_2Mbps_viterbi_cs_40MHz_channelConfig = {
  .phyConfigBase = sl_rail_ble_phy_1Mbps_viterbi_cs_40MHz_modemConfigBase,
  .phyConfigDeltaSubtract = NULL,
  .configs = sl_rail_ble_phy_2Mbps_viterbi_cs_40MHz_channels,
  .length = 1U,
  .signature = 0UL,
  .xtalFrequencyHz = 40000000UL,
};
