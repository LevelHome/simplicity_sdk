...
class Profile_Base_Ocelot(Profile_Base):
    ...
    def build_hidden_profile_inputs(self, model, profile):
        ...
        IProfile.make_hidden_input(profile, model.vars.maximize_bwsel_range, "Advanced",
                                   readable_name="Maximize difference between acquisition and lock bandwidth")
        IProfile.make_hidden_input(profile, model.vars.trecs_optimize_cost_thd, "Advanced",
                                   readable_name="Enable conservative preamble cost threshold calculation")
        IProfile.make_hidden_input(profile, model.vars.trecs_weak_syncword_optimization, "Advanced",
                                   readable_name="Optimize threshold for packet reception using weak syncword")
        ...
        IProfile.make_hidden_input(profile, model.vars.afc_run_mode, 'Advanced', readable_name="AFC Run mode")
