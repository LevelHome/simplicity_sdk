...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG22X000F512IM32_RevB2``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG22X000F512IM32_RevB2
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG22X000F512IM32_RevB2' ]
...
class RM_Device_EFR32XG22X000F512IM32_RevB2(Base_RM_Device):
    """
