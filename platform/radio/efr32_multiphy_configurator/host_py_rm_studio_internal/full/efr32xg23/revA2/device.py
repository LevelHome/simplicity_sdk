...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG23A000F512GM40_RevA2``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG23A000F512GM40_RevA2
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG23A000F512GM40_RevA2' ]
...
class RM_Device_EFR32XG23A000F512GM40_RevA2(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG23A000F512GM40_RevA2, self).__init__(rmio, label,
            'EFR32XG23A000F512GM40',
            RM_SVD_Info('EFR32XG23A000F512GM40_SEQ.svd', '7e38df7f5f8ef434e11d56f0d16c95e2'))
