...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32X21X000F1024XM32_RevC0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32X21X000F1024XM32_RevC0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32X21X000F1024XM32_RevC0' ]
...
class RM_Device_EFR32X21X000F1024XM32_RevC0(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32X21X000F1024XM32_RevC0, self).__init__(rmio, label,
            'EFR32X21X000F1024XM32',
            RM_SVD_Info('EFR32X21X000F1024XM32_SEQ.svd', 'a979e38e49509667c5870af5781b4503'))
