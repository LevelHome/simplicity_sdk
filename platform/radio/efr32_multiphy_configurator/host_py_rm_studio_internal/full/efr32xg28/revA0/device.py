...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG28XFULL_RevA0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG28XFULL_RevA0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG28XFULL_RevA0' ]
...
class RM_Device_EFR32XG28XFULL_RevA0(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG28XFULL_RevA0, self).__init__(rmio, label,
            'EFR32XG28XFULL',
            RM_SVD_Info('EFR32XG28XFULL_SEQ.svd', '9c1b4a0d87ebfcfe7a9debf2ac74111f'))
