...
__all__ = [ 'RM_Device_EFR32XG27XFULL_RevA1' ]
...
class RM_Device_EFR32XG27XFULL_RevA1(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG27XFULL_RevA1, self).__init__(rmio, label,
            'EFR32XG27XFULL',
            RM_SVD_Info('EFR32XG27XFULL_SEQ.svd', '00d842ff61f02fd9148f88a7bb0d6d3d'))
