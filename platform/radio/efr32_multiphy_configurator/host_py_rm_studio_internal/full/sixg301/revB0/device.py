...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_SIXG301XFULL_RevB0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_SIXG301XFULL_RevB0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_SIXG301XFULL_RevB0' ]
...
class RM_Device_SIXG301XFULL_RevB0(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_SIXG301XFULL_RevB0, self).__init__(rmio, label,
            'SIXG301XFULL',
            RM_SVD_Info('SIXG301XFULL_SEQ.svd', 'b0e132779c58ced80388bd67cafddad6'))
