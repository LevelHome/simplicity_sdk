...
/****************************************************************************************************
 ****************************************************************************************************
 *                                 CMSIS RTOS 2 COMPATIBILITY LAYER
 *
 * This file countains the cmsis rtos 2 compatibility layer implementation for the micrium kernel. 
 * This software component is reserved for internal use and shouldn't be used by user code.
 *
 ****************************************************************************************************
 ***************************************************************************************************/
...
SL_CODE_CLASSIFY(SL_CODE_COMPONENT_MICRIUMOS_KERNEL,
