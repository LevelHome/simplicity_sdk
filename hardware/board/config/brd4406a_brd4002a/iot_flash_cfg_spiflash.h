...
// USART0 TX on PB00
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PORT       SL_GPIO_PORT_B
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PIN        0

// USART0 RX on PB01
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PORT       SL_GPIO_PORT_B
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PIN        1

// USART0 CLK on PB02
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PORT      SL_GPIO_PORT_B
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PIN       2

// USART0 CS on PA00
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PORT       SL_GPIO_PORT_A
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PIN        0
