...
// <o IOT_I2C_CFG_SENSOR_INST_NUM> Instance number
// <i> Instance number used when iot_i2c_open() is called.
// <i> Default: 0
#define IOT_I2C_CFG_SENSOR_INST_NUM           0

// <o  IOT_I2C_CFG_SENSOR_DEFAULT_TIMEOUT> Default timeout (in msec)
// <i> Default: 500
#define IOT_I2C_CFG_SENSOR_DEFAULT_TIMEOUT    500

// <o  IOT_I2C_CFG_SENSOR_DEFAULT_FREQ> Default bus speed
...
// <q  IOT_I2C_CFG_SENSOR_ACCEPT_NACK> Accept NACK
...
// <gpio optional=true> IOT_I2C_CFG_SENSOR_ENABLE
// $[GPIO_IOT_I2C_CFG_SENSOR_ENABLE]

// [GPIO_IOT_I2C_CFG_SENSOR_ENABLE]$

// <i2c signal=SCL,SDA> IOT_I2C_CFG_SENSOR
// $[I2C_IOT_I2C_CFG_SENSOR]
#define IOT_I2C_CFG_SENSOR_PERIPHERAL            I2C2
#define IOT_I2C_CFG_SENSOR_PERIPHERAL_NO         2

// I2C2 SCL on PB02
#define IOT_I2C_CFG_SENSOR_SCL_PORT              SL_GPIO_PORT_B
#define IOT_I2C_CFG_SENSOR_SCL_PIN               2

// I2C2 SDA on PB03
#define IOT_I2C_CFG_SENSOR_SDA_PORT              SL_GPIO_PORT_B
