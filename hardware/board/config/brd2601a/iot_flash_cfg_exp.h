...
// <o IOT_FLASH_CFG_EXP_INST_NUM> Instance number
...
// <o  IOT_FLASH_CFG_EXP_SPI_BITRATE> Default SPI bitrate
// <i> Default: 1000000
#define IOT_FLASH_CFG_EXP_SPI_BITRATE           1000000

// <o  IOT_FLASH_CFG_EXP_SPI_FRAME_LENGTH> Default SPI frame length <4-16>
// <i> Default: 8
#define IOT_FLASH_CFG_EXP_SPI_FRAME_LENGTH      8

// <o  IOT_FLASH_CFG_EXP_SPI_TYPE> Default SPI master/slave mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define IOT_FLASH_CFG_EXP_SPI_TYPE              spidrvMaster

// <o  IOT_FLASH_CFG_EXP_SPI_BIT_ORDER> Default SPI bit order
...
// <o  IOT_FLASH_CFG_EXP_SPI_CLOCK_MODE> Default SPI clock mode
...
// <o  IOT_FLASH_CFG_EXP_SPI_CS_CONTROL> Default SPI CS control scheme
...
// <o  IOT_FLASH_CFG_EXP_SPI_SLAVE_START_MODE> Default SPI transfer scheme
...
// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,CLK,CS> IOT_FLASH_CFG_EXP_SPI
...
#define IOT_FLASH_CFG_EXP_SPI_TX_PIN             3
...
#define IOT_FLASH_CFG_EXP_SPI_CLK_PIN            1

// USART0 CS on PA07
#define IOT_FLASH_CFG_EXP_SPI_CS_PORT            SL_GPIO_PORT_A
#define IOT_FLASH_CFG_EXP_SPI_CS_PIN             7
