...
#define IOT_SPI_CFG_LOOPBACK_TX_PIN              5

// USART0 RX on PC03
#define IOT_SPI_CFG_LOOPBACK_RX_PORT             SL_GPIO_PORT_C
#define IOT_SPI_CFG_LOOPBACK_RX_PIN              3
...
// USART0 CS on PC06
#define IOT_SPI_CFG_LOOPBACK_CS_PORT             SL_GPIO_PORT_C
#define IOT_SPI_CFG_LOOPBACK_CS_PIN              6
