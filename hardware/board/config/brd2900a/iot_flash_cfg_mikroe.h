...
// <o  IOT_FLASH_CFG_MIKROE_SPI_BITRATE> Default SPI bitrate
// <i> Default: 1000000
#define IOT_FLASH_CFG_MIKROE_SPI_BITRATE           1000000

// <o  IOT_FLASH_CFG_MIKROE_SPI_FRAME_LENGTH> Default SPI frame length <4-16>
// <i> Default: 8
#define IOT_FLASH_CFG_MIKROE_SPI_FRAME_LENGTH      8

// <o  IOT_FLASH_CFG_MIKROE_SPI_TYPE> Default SPI master/slave mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define IOT_FLASH_CFG_MIKROE_SPI_TYPE              spidrvMaster

// <o  IOT_FLASH_CFG_MIKROE_SPI_BIT_ORDER> Default SPI bit order
...
// <o  IOT_FLASH_CFG_MIKROE_SPI_CLOCK_MODE> Default SPI clock mode
...
// <o  IOT_FLASH_CFG_MIKROE_SPI_CS_CONTROL> Default SPI CS control scheme
...
// <o  IOT_FLASH_CFG_MIKROE_SPI_SLAVE_START_MODE> Default SPI transfer scheme
...
// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,CLK,CS> IOT_FLASH_CFG_MIKROE_SPI
...
// USART0 TX on PD03
#define IOT_FLASH_CFG_MIKROE_SPI_TX_PORT         SL_GPIO_PORT_D
#define IOT_FLASH_CFG_MIKROE_SPI_TX_PIN          3

// USART0 RX on PD02
#define IOT_FLASH_CFG_MIKROE_SPI_RX_PORT         SL_GPIO_PORT_D
#define IOT_FLASH_CFG_MIKROE_SPI_RX_PIN          2

// USART0 CLK on PC00
#define IOT_FLASH_CFG_MIKROE_SPI_CLK_PORT        SL_GPIO_PORT_C
#define IOT_FLASH_CFG_MIKROE_SPI_CLK_PIN         0

// USART0 CS on PC01
#define IOT_FLASH_CFG_MIKROE_SPI_CS_PORT         SL_GPIO_PORT_C
#define IOT_FLASH_CFG_MIKROE_SPI_CS_PIN          1
