...
#define IOT_FLASH_CFG_SPIFLASH_SPI_PERIPHERAL    USART2
#define IOT_FLASH_CFG_SPIFLASH_SPI_PERIPHERAL_NO 2

// USART2 TX on PD00
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PORT       SL_GPIO_PORT_D
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PIN        0

// USART2 RX on PD01
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PORT       SL_GPIO_PORT_D
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PIN        1

// USART2 CLK on PD02
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PORT      SL_GPIO_PORT_D
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PIN       2

// USART2 CS on PD03
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PORT       SL_GPIO_PORT_D
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PIN        3
