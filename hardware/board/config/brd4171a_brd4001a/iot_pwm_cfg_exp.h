...
#define IOT_PWM_CFG_EXP_PERIPHERAL               TIMER3
#define IOT_PWM_CFG_EXP_PERIPHERAL_NO            3

// TIMER3 CC0 on PC02
#define IOT_PWM_CFG_EXP_CC0_PORT                 SL_GPIO_PORT_C
#define IOT_PWM_CFG_EXP_CC0_PIN                  2
