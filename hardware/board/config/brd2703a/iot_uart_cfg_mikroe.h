...
// <o IOT_UART_CFG_MIKROE_INST_NUM> Instance number
// <i> Instance number used when iot_uart_open() is called.
// <i> Default: 0
#define IOT_UART_CFG_MIKROE_INST_NUM                    0

// <o IOT_UART_CFG_MIKROE_DEFAULT_BAUDRATE> Default baud rate
// <i> Default: 115200
#define IOT_UART_CFG_MIKROE_DEFAULT_BAUDRATE            115200

// <o IOT_UART_CFG_MIKROE_DEFAULT_DATA_BITS> Default number of data bits
...
// <o IOT_UART_CFG_MIKROE_DEFAULT_PARITY> Default parity mode
...
// <o IOT_UART_CFG_MIKROE_DEFAULT_STOP_BITS> Default number of stop bits
...
// <o IOT_UART_CFG_MIKROE_DEFAULT_FLOW_CONTROL_TYPE> Default hardware flow control
...
// <q IOT_UART_CFG_MIKROE_LOOPBACK> Internal Loopback
...
// USART0 TX on PD04
#define IOT_UART_CFG_MIKROE_TX_PORT              SL_GPIO_PORT_D
#define IOT_UART_CFG_MIKROE_TX_PIN               4

// USART0 RX on PD05
#define IOT_UART_CFG_MIKROE_RX_PORT              SL_GPIO_PORT_D
