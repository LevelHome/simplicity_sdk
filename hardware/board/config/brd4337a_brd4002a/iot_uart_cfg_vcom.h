...
// USART0 TX on PD01
#define IOT_UART_CFG_VCOM_TX_PORT                SL_GPIO_PORT_D
#define IOT_UART_CFG_VCOM_TX_PIN                 1

// USART0 RX on PD00
#define IOT_UART_CFG_VCOM_RX_PORT                SL_GPIO_PORT_D
#define IOT_UART_CFG_VCOM_RX_PIN                 0



// USART0 RTS on PC02
#define IOT_UART_CFG_VCOM_RTS_PORT               SL_GPIO_PORT_C
#define IOT_UART_CFG_VCOM_RTS_PIN                2

// USART0 CTS on PC03
#define IOT_UART_CFG_VCOM_CTS_PORT               SL_GPIO_PORT_C
#define IOT_UART_CFG_VCOM_CTS_PIN                3
