...
#define SL_RAIL_UTIL_AOX_ANTENNA_PIN0_PORT       SL_GPIO_PORT_B
#define SL_RAIL_UTIL_AOX_ANTENNA_PIN0_PIN        3
...
#define SL_RAIL_UTIL_AOX_ANTENNA_PIN1_PORT       SL_GPIO_PORT_B
#define SL_RAIL_UTIL_AOX_ANTENNA_PIN1_PIN        4
