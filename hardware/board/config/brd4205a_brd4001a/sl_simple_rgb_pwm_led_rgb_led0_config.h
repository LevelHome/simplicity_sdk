...
#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_RED_PIN   4

#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_GREEN_CHANNEL 1
// TIMER0 CC1 on PB05
#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_GREEN_PORT SL_GPIO_PORT_B
#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_GREEN_PIN 5

#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_BLUE_CHANNEL 2
// TIMER0 CC2 on PB06
#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_BLUE_PORT SL_GPIO_PORT_B
#define SL_SIMPLE_RGB_PWM_LED_RGB_LED0_BLUE_PIN  6
