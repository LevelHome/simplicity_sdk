...
// <o IOT_I2C_CFG_QWIIC_INST_NUM> Instance number
// <i> Instance number used when iot_i2c_open() is called.
// <i> Default: 0
#define IOT_I2C_CFG_QWIIC_INST_NUM           0

// <o  IOT_I2C_CFG_QWIIC_DEFAULT_TIMEOUT> Default timeout (in msec)
// <i> Default: 500
#define IOT_I2C_CFG_QWIIC_DEFAULT_TIMEOUT    500

// <o  IOT_I2C_CFG_QWIIC_DEFAULT_FREQ> Default bus speed
...
// <q  IOT_I2C_CFG_QWIIC_ACCEPT_NACK> Accept NACK
...
// <gpio optional=true> IOT_I2C_CFG_QWIIC_ENABLE
// $[GPIO_IOT_I2C_CFG_QWIIC_ENABLE]

// [GPIO_IOT_I2C_CFG_QWIIC_ENABLE]$

// <i2c signal=SCL,SDA> IOT_I2C_CFG_QWIIC
// $[I2C_IOT_I2C_CFG_QWIIC]
#define IOT_I2C_CFG_QWIIC_PERIPHERAL             I2C0
#define IOT_I2C_CFG_QWIIC_PERIPHERAL_NO          0

// I2C0 SCL on PB03
#define IOT_I2C_CFG_QWIIC_SCL_PORT               SL_GPIO_PORT_B
#define IOT_I2C_CFG_QWIIC_SCL_PIN                3

// I2C0 SDA on PB04
#define IOT_I2C_CFG_QWIIC_SDA_PORT               SL_GPIO_PORT_B
#define IOT_I2C_CFG_QWIIC_SDA_PIN                4
