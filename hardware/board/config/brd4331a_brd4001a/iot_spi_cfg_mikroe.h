...
// <o IOT_SPI_CFG_MIKROE_INST_NUM> Instance number
// <i> Instance number used when iot_spi_open() is called.
// <i> Default: 0
#define IOT_SPI_CFG_MIKROE_INST_NUM                  0

// <o  IOT_SPI_CFG_MIKROE_DEFAULT_BITRATE> Default SPI bitrate
// <i> Default: 1000000
#define IOT_SPI_CFG_MIKROE_DEFAULT_BITRATE           1000000

// <o  IOT_SPI_CFG_MIKROE_DEFAULT_FRAME_LENGTH> Default SPI frame length <4-16>
// <i> Default: 8
#define IOT_SPI_CFG_MIKROE_DEFAULT_FRAME_LENGTH      8

// <o  IOT_SPI_CFG_MIKROE_DEFAULT_TYPE> Default SPI master/slave mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define IOT_SPI_CFG_MIKROE_DEFAULT_TYPE              spidrvMaster

// <o  IOT_SPI_CFG_MIKROE_DEFAULT_BIT_ORDER> Default SPI bit order
...
// <o  IOT_SPI_CFG_MIKROE_DEFAULT_CLOCK_MODE> Default SPI clock mode
...
// <o  IOT_SPI_CFG_MIKROE_DEFAULT_CS_CONTROL> Default SPI CS control scheme
...
// <o  IOT_SPI_CFG_MIKROE_DEFAULT_SLAVE_START_MODE> Default SPI transfer scheme
...
// <q IOT_SPI_CFG_MIKROE_LOOPBACK> Internal Loopback
...
// <<< sl:start pin_tool >>>
// <usart signal=TX,RX,CLK,CS> IOT_SPI_CFG_MIKROE
