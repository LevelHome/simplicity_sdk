...
#define IOT_UART_CFG_VCOM_TX_PIN                 7
...
// USART0 RTS on PB02
#define IOT_UART_CFG_VCOM_RTS_PORT               SL_GPIO_PORT_B
#define IOT_UART_CFG_VCOM_RTS_PIN                2

// USART0 CTS on PB04
#define IOT_UART_CFG_VCOM_CTS_PORT               SL_GPIO_PORT_B
#define IOT_UART_CFG_VCOM_CTS_PIN                4
