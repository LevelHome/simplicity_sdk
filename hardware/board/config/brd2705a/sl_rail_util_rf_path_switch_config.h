...
#define SL_RAIL_UTIL_RF_PATH_SWITCH_RADIO_ACTIVE_PORT SL_GPIO_PORT_D
#define SL_RAIL_UTIL_RF_PATH_SWITCH_RADIO_ACTIVE_PIN 3
...
#define SL_RAIL_UTIL_RF_PATH_SWITCH_CONTROL_PORT SL_GPIO_PORT_B
