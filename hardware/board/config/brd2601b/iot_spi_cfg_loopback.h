...
// USART0 TX on PC03
#define IOT_SPI_CFG_LOOPBACK_TX_PORT             SL_GPIO_PORT_C
#define IOT_SPI_CFG_LOOPBACK_TX_PIN              3

// USART0 RX on PC02
#define IOT_SPI_CFG_LOOPBACK_RX_PORT             SL_GPIO_PORT_C
#define IOT_SPI_CFG_LOOPBACK_RX_PIN              2

// USART0 CLK on PC01
#define IOT_SPI_CFG_LOOPBACK_CLK_PORT            SL_GPIO_PORT_C
#define IOT_SPI_CFG_LOOPBACK_CLK_PIN             1

// USART0 CS on PA07
#define IOT_SPI_CFG_LOOPBACK_CS_PORT             SL_GPIO_PORT_A
#define IOT_SPI_CFG_LOOPBACK_CS_PIN              7
