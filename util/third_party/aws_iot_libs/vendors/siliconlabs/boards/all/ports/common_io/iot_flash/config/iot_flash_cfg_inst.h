...
// <o IOT_FLASH_CFG_INSTANCE_EXTERNAL_FLASH_BASE> External Flash Base Address <f.h>
// <i> Hex value of the base address of the external flash used.
// <i> Default: 0x0
#define IOT_FLASH_CFG_INSTANCE_EXTERNAL_FLASH_BASE   0x0
