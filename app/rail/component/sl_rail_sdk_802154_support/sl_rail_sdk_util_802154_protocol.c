 ...
 *****************************************************************************/
static RAIL_Status_t sl_rail_sdk_util_protocol_config_ieee802154_2p4ghz(RAIL_Handle_t handle,
 ...
 * @return RAIL status, RAIL_STATUS_NO_ERROR if the configuration has been successful.
 *****************************************************************************/
static RAIL_Status_t sl_rail_sdk_util_protocol_config_ieee802154_gb868_863mhz(RAIL_Handle_t handle,
                                                                              sl_rail_sdk_util_802154_protocol_type_t protocol);
 ...
 * @return RAIL status, RAIL_STATUS_NO_ERROR if the configuration has been successful.
 *****************************************************************************/
static RAIL_Status_t sl_rail_sdk_util_protocol_config_ieee802154_gb868_915mhz(RAIL_Handle_t handle,
                                                                              sl_rail_sdk_util_802154_protocol_type_t protocol);
#endif
...
// -----------------------------------------------------------------------------
RAIL_Status_t sl_rail_sdk_util_802154_protocol_config(RAIL_Handle_t handle,
                                                      sl_rail_sdk_util_802154_protocol_type_t protocol)
{
  switch (protocol) {
#if RAIL_FEAT_2G4_RADIO
