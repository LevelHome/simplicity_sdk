/***************************************************************************//**
 * @file sl_rail_sdk_ieee802154_support.h
...
#ifndef SL_RAIL_SDK_IEEE802154_SUPPORT_H
#define SL_RAIL_SDK_IEEE802154_SUPPORT_H
...
// some board does not support the unwhitening.
  ...
  #define APP_WHITENING_ON_OFF             SL_RAIL_SDK_IEEE802154G_PHR_DATA_WHITENING_ON
#endif

/// IEEE 802.15.4 error
#define SL_RAIL_SDK_IEEE802154_ERROR                    (-1)
/// IEEE 802.15.4 ok
#define SL_RAIL_SDK_IEEE802154_OK                       (0)
/// IEEE 802.15.4 unsupported protocol
#define SL_RAIL_SDK_IEEE802154_UNSUPPORTED_PROTOCOL     (1)
/// IEEE 802.15.4 unsupported RF band
#define SL_RAIL_SDK_IEEE802154_UNSUPPORTED_RF_BAND      (2)

// IEEE 802.15.4 macros
/// First 2.4GHz channel that can be used for IEEE Std. 802.15.4 (e.g 11)
#define SL_RAIL_SDK_IEEE802154_CHANNEL_2P4              (0x0B)
/// First 863MHz channel that can be used for IEEE Std. 802.15.4g (e.g 128)
#define SL_RAIL_SDK_IEEE802154_CHANNEL_863              (0x80)
/// First 863MHz channel that can be used for IEEE Std. 802.15.4g (e.g 224)
#define SL_RAIL_SDK_IEEE802154_CHANNEL_915              (0xE0)

/// Two IEEE Std. 802.15.4 variants
typedef enum {
  SL_RAIL_SDK_IEEE802154_STD_IEEE802154_2P4GHZ,     //!< IEEE 802.15.4 basic (2P4GHz)
  SL_RAIL_SDK_IEEE802154_STD_IEEE802154G_863MHZ,    //!< IEEE 802.15.4g (863MHz)
  SL_RAIL_SDK_IEEE802154_STD_IEEE802154G_915MHZ     //!< IEEE 802.15.4g (915MHz)
} sl_rail_sdk_ieee802154_std_t;

/// Structure for IEEE 802154 frames
typedef struct {
  uint8_t phr_config;
  sl_rail_sdk_802154_packet_mhr_frame_t mhr_config;
  uint16_t payload_size;
  void *payload;
} sl_rail_sdk_ieee802154_frame_t;
...
} sl_rail_sdk_ieee802154_cli_requests;

/// Structure for CLI desired setting values
typedef struct {
  sl_rail_sdk_ieee802154_std_t desired_std;
  ...
  bool desired_dw;
  uint8_t desired_crc;
} sl_rail_sdk_ieee802154_cli_data;
...
typedef struct {
  ...
  bool data_whitening;
  uint8_t crc_length;
} sl_rail_sdk_ieee802154_status_t;
 ...
 * @retval SL_RAIL_SDK_IEEE802154_ERROR   the initialization failed
 * @retval SL_RAIL_SDK_IEEE802154_OK      the initialization run successfully
 * @retval SL_RAIL_SDK_IEEE802154_UNSUPPORTED_PROTOCOL no IEEE 802.15.4 protocol
 ...
 *
 * @remark It is worth calling this after sl_rail_sdk_ieee802154_protocol_init() that
 ...
 * @param[in] frame     frame contains all information for the standard frame
 *****************************************************************************/
 ...
 *****************************************************************************/
void sl_rail_sdk_ieee802154_prepare_sending(sl_rail_sdk_ieee802154_frame_t *frame,
...
#endif // SL_RAIL_SDK_IEEE802154_SUPPORT_H
