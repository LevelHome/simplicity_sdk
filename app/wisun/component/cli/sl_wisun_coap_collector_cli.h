/***************************************************************************//**
 * @file sl_wisun_coap_collector_cli.h
...
#ifndef SL_WISUN_COAP_COLLECTOR_CLI_H
#define SL_WISUN_COAP_COLLECTOR_CLI_H
...
/**************************************************************************//**
 * @brief App LED toggle CLI handler
...
/**************************************************************************//**
 * @brief App register meter CLI handler
 * @details CLI function
 * @param[in] arguments Arguments
 *****************************************************************************/
...
/**************************************************************************//**
 * @brief App remove meter CLI handler
 * @details CLI function
 * @param[in] arguments Arguments
 *****************************************************************************/
...
/**************************************************************************//**
 * @brief App async request CLI handler
 * @details CLI function
 * @param[in] arguments Arguments
 *****************************************************************************/
...
/**************************************************************************//**
 * @brief App list meters CLI handler
 * @details CLI function
 * @param[in] arguments Arguments
 *****************************************************************************/
...
#endif // SL_WISUN_COAP_COLLECTOR_CLI_H
