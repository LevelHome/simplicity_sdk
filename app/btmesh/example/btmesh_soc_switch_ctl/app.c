...
static uint8_t lightness_last = 0;
...
static void set_device_name(uuid_128 *uuid)
{
  ...
  snprintf(name, NAME_BUF_LEN, "Switch CTL %02x%02x",
...
void app_button_press_cb(uint8_t button, uint8_t duration)
{
  ...
  if (button == BUTTON_PRESS_BUTTON_0) {
    switch (duration) {
      ...
      case APP_BUTTON_PRESS_DURATION_SHORT: {
        ...
        lightness_last = lightness_percent;
      ...
      case APP_BUTTON_PRESS_DURATION_VERYLONG: {
        lightness_percent = lightness_percent == 0 ? lightness_last : 0;
        sl_btmesh_ctl_client_set_lightness(lightness_percent);
      } break;
      default:
        break;
  ...
  switch (duration) {
    ...
    case APP_BUTTON_PRESS_DURATION_LONG:
    case APP_BUTTON_PRESS_DURATION_VERYLONG: {
      lightness_percent = button == BUTTON_PRESS_BUTTON_0 ? 0 : lightness_last;
      sl_btmesh_ctl_client_set_lightness(lightness_percent);
    } break;
    default:
      break;
