# Bluetooth Mesh - NLC Occupancy Sensor FreeRTOS

The **Bluetooth Mesh - NLC Occupancy Sensor FreeRTOS** example is a working example application that you can use as an Occupancy Sensor node in a Networked Lighting Control (NLC) network. The project is based on a Real Time Operating System, which in this case is FreeRTOS.
...
## Testing the Bluetooth Mesh - NLC Occupancy Sensor FreeRTOS Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - NLC Occupancy Sensor FreeRTOS** example to your device.
