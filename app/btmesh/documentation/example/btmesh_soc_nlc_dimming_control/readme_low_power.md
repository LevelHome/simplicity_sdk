# Bluetooth Mesh - NLC Dimming Control Low Power

The **Bluetooth Mesh - NLC Dimming Control Low Power** example is a working example application that you can use as a Dimming Control node in a Networked Lighting Control (NLC) network.
...
## Testing the Bluetooth Mesh - NLC Dimming Control Low Power Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - NLC Dimming Control Low Power** example to the device.
