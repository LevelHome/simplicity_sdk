# Bluetooth Mesh - NLC Dimming Control RTOS

The **Bluetooth Mesh - NLC Dimming Control FreeRTOS/Micrium OS** example is a working example application that you can use as a Dimming Control node in a Networked Lighting Control (NLC) network.
...
## Testing the Bluetooth Mesh - NLC Dimming Control FreeRTOS/Micrium OS Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - NLC Dimming Control FreeRTOS/Micrium OS** example to the device.
