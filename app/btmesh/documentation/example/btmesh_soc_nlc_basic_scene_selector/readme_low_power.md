# Bluetooth Mesh - NLC Basic Scene Selector Low Power

The **Bluetooth Mesh - NLC Basic Scene Selector Low Power** example is a working example application that you can use as a Basic Scene Selector node in a Networked Lighting Control (NLC) network.
...
## Testing the Bluetooth Mesh - NLC Basic Scene Selector Low Power Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - NLC Basic Scene Selector Low Power** example to the device.
