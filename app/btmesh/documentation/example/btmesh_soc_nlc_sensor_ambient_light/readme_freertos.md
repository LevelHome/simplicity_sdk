# Bluetooth Mesh - NLC Ambient Light Sensor FreeRTOS

The **Bluetooth Mesh - NLC Ambient Light Sensor FreeRTOS** example is a working example application that you can use as an Ambient Light Sensor node in a Networked Lighting Control (NLC) network. The project is based on a Real Time Operating System, which in this case is FreeRTOS.
...
**Bluetooth Mesh - NLC Ambient Light Sensor FreeRTOS** example makes ambient light sensor measurements and forwards them to another node, for example an NLC Basic Lightness Controller (**Bluetooth Mesh - NLC Basic Lightness Controller**) or a Sensor Client Node (one of the **Bluetooth Mesh - Sensor Client** examples).
...
## Testing the Bluetooth Mesh - NLC Ambient Light Sensor FreeRTOS Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - NLC Ambient Light Sensor FreeRTOS** example to your device.
